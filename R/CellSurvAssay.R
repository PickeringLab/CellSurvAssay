#' CellSurvAssay
#'
#' This R package has been written around \code{CFAssay}, another R package that
...
#'   automates the data wrangling steps to the extent that only single lines of
#'   code suffice for each step of the analysis, * it utilizes \code{ggplot()}
#'   to plot the cell survival curves, and builds better quality figures than
#'   other available R packages, * it is less time consuming and more convenient
#'   for the user, as it accepts the raw data for the analysis and calculates
#'   the plating efficiencies by itself, unlike many automated software commonly
#'   used, * it offers various method options for parameter estimation and
#'   calculating plating efficiencies, unlike most other available software
